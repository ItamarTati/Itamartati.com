...
const hemisphereLight = new THREE.HemisphereLight(0xffffff, 0xffffff, 2); // Increased intensity
...
const pointLight3 = new THREE.PointLight(0xffffff, 2); // Increased intensity
